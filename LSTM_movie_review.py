...
#X_train - document data들을 토큰화 시킨 데이터 , Y_train - label 한마디로 답지?
#test_size : 0.2 -> 전체 데이터 중 20%는 시험을 볼 것이다. 80%가 학습 데이터
#random_state : 숫자만 통일시키면 같은 값이 나옴..? -> 0이면 원래 데이터 순서대로,
#stratify : 클래스 분포 비율까지 맞춤
...
class TextClassifier(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim):
        ...
        #LSTM - [sequence, batch_size, input_size], [sequence, batch_size, hidden_size] => batch_first = True : [batch_size, sequence, input_size], [batch_size, sequence, hidden_size]
...
num_epochs = 10
print("LSTM learning rate : 1e-4, num : 10")
